...
const CreateBlog = () => {
    return <div className="flex h-screen justify-center p-4 w-screen border border-lime-700">
        <div className="w-full flex flex-col gap-10 mt-10 md:w-[80vw] lg:w-[80vw] ">
            <div>
                <input type="text" id="helper-text" aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4" placeholder="Title..." />
            </div>
